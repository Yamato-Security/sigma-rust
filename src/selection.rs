...
impl TryFrom<serde_yaml_ng::Mapping> for FieldGroup {
    type Error = ParserError;
    fn try_from(mapping: serde_yaml_ng::Mapping) -> Result<Self, Self::Error> {
        let mut fields = vec![];
...
mod tests {
    ...
    selection:
        ...
        RandomID|contains:
            ...
            - ed
"#;
        let data: serde_yaml_ng::Mapping = serde_yaml_ng::from_str(yaml).unwrap();
